...
def psuedolabel_data(model, train_dataset_labeled, train_dataset_unlabeled, gmm, epoch, train_stats, top_k, args):
    ...
    filtered_labels = filtered_labels[sorted_indices].detach().cpu().numpy()
    filtered_indicies = filtered_indicies[sorted_indices].detach().cpu().numpy()
    filtered_preds = filtered_preds[sorted_indices].detach().cpu().numpy()
