...
ifp = '/home/mmajurski/github/ssl-gmm/usb/saved_models/aagmm_cf10w100'
...
for fldr in fldrs:
    ...
    try:
        ...
        pass
    del toks[2]  # get rid of notation that is ood
    dataset = toks[1]
...
results_df.to_csv('results-usb-ood.csv', index=False)
stats_df.to_csv('results-usb-ood-stats.csv', index=False)
