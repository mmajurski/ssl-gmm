...
\begin{abstract}
	% TODO motiviate why gmm and why descriminitive models over linear layer.
...
\begin{figure}[ht]
	\centering
	\subfloat{\includegraphics[width=.5\columnwidth]{figures/id-00000121-tsne.jpg}}
	\subfloat{\includegraphics[width=.5\columnwidth]{figures/id-00000409-tsne.jpg}}
	\\
	\subfloat{\includegraphics[width=.5\columnwidth]{figures/id-00000150-tsne.jpg}}
	\subfloat{\includegraphics[width=.5\columnwidth]{figures/id-00000415-tsne.jpg}}
	
	%	\includegraphics[width=0.9\linewidth]{example-image-a}
	\caption{t-SNE embedding of latent embedding space for various final network layers with or without a 1st order Method of Moments constraint.}
	\label{fig:schema}
\end{figure}
