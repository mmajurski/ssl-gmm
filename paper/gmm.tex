...
% TODO talk about clustering method from enguehard2019semi
...
%These fully connected layer replacements represent differing levels of prescription about how the final embedding space should be arranged.
...
%
%The first four gaussian moments being identity/zero increasingly constrain the model embedding space right before the last layer. 
