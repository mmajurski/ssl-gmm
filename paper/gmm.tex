...
%With the 8-dimensional embedding constraint with 40 labels, we see that the K-means model exhibits high variance in testing accuracy, whereas the variance in testing accuracy is much lower with the KMeans 128 in 128 dimensions
...
% Steve Lund comment: "Based on the first complete paragraph on page 2, I was expecting to see an example showing how your proposed model flagged outliers or produced more moderate estimated class probabilities for an outlier versus the traditional softmax output."
