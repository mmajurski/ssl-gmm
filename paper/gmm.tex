...
\begin{table*}[ht!]
	...
	%TODO update table with final few missing runs to bring N=5
	\label{table1}
\end{table*}
...
% TODO (chapman) need citation for VAE inference methods
...
\begin{table}[h!]
	...
	% TODO (majurski) update table with final few currently running experiments
