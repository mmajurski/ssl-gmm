...
def gather_models_results():
    ...
    ifp = '/home/mmajurski/Downloads/gmm-multi-cluster'

    cluster_vals = [1, 2, 3, 4, 5]
        ...
        for c in cluster_vals:
            ...
            for m in methods:
                for inf in inf_types:
                    ...
                    for p in lcl_p_vals:
                        if p is None:
                            m_fp = "ssl-{}-method{}-n{}-c{}-models".format(inf, m, n, c)
                        else:
                            m_fp = "ssl-{}-method{}-thres{}-n{}-c{}-models".format(inf, m, p, n, c)
